...
func _draw_plain_detail(rect: Rect2, x: int, y: int) -> void:
	...
	if bridge_neighbors > 0 and river_neighbors == 0:
		...
		if bridge_vertical:
			if _terrain_at_or_cliff(x, y - 1) == TERRAIN_BRIDGE:
				...
				draw_line(Vector2(rect.position.x + 18, rect.position.y + 14),
					Vector2(rect.position.x + rect.size.x - 18, rect.position.y + 14),
					Color(0.52, 0.44, 0.30, 0.16), 2.0, true)
			if _terrain_at_or_cliff(x, y + 1) == TERRAIN_BRIDGE:
			...
			if _terrain_at_or_cliff(x - 1, y) == TERRAIN_BRIDGE:
				...
				draw_line(Vector2(rect.position.x + 14, rect.position.y + 18),
					Vector2(rect.position.x + 14, rect.position.y + rect.size.y - 18),
					Color(0.52, 0.44, 0.30, 0.14), 2.0, true)
			if _terrain_at_or_cliff(x + 1, y) == TERRAIN_BRIDGE:
	...
	if gate_vertical:
		...
		if gate_vertical and wall_contact.get("east", false):
			...
			draw_line(Vector2(rect.position.x + rect.size.x - 15, rect.position.y + 12),
				Vector2(rect.position.x + rect.size.x - 15, rect.position.y + rect.size.y - 12),
				Color(0.10, 0.08, 0.06, 0.18), 2.0, true)
	...
	if gate_horizontal:
		...
		if gate_horizontal and wall_contact.get("south", false):
			...
			draw_line(Vector2(rect.position.x + 12, rect.position.y + rect.size.y - 15),
				Vector2(rect.position.x + rect.size.x - 12, rect.position.y + rect.size.y - 15),
				Color(0.10, 0.08, 0.06, 0.18), 2.0, true)
...
func _draw_river_detail(rect: Rect2, x: int, y: int) -> void:
	...
	if bridge_neighbors > 0 and horizontal_flow and banks.get("north", false):
		...
		draw_line(Vector2(rect.position.x + 12, rect.position.y + 10),
			Vector2(rect.position.x + rect.size.x - 12, rect.position.y + 10),
			Color(0.58, 0.48, 0.30, 0.16), 2.0, true)
	if bridge_neighbors > 0 and horizontal_flow and banks.get("south", false):
		...
		draw_line(Vector2(rect.position.x + 12, rect.position.y + rect.size.y - 10),
			Vector2(rect.position.x + rect.size.x - 12, rect.position.y + rect.size.y - 10),
			Color(0.10, 0.08, 0.06, 0.16), 2.0, true)
	if bridge_neighbors > 0 and not horizontal_flow and banks.get("west", false):
		draw_rect(Rect2(rect.position.x + 4, rect.position.y + 12, 8, rect.size.y - 24),
			Color(0.28, 0.22, 0.14, 0.18))
		draw_line(Vector2(rect.position.x + 10, rect.position.y + 12),
			Vector2(rect.position.x + 10, rect.position.y + rect.size.y - 12),
			Color(0.58, 0.48, 0.30, 0.14), 2.0, true)
	if bridge_neighbors > 0 and not horizontal_flow and banks.get("east", false):
		draw_rect(Rect2(rect.position.x + rect.size.x - 12, rect.position.y + 12, 8, rect.size.y - 24),
			Color(0.14, 0.10, 0.06, 0.20))
		draw_line(Vector2(rect.position.x + rect.size.x - 10, rect.position.y + 12),
			Vector2(rect.position.x + rect.size.x - 10, rect.position.y + rect.size.y - 12),
			Color(0.10, 0.08, 0.06, 0.14), 2.0, true)
